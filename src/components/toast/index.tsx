  ...
  return (
    <div
      className={`${show ? 'scale-100 opacity-100' : ' scale-75 opacity-0'} ${
        ...
        position === 'bottom-center' ? '' : 'md:left-auto md:right-4'
      } fixed z-10 left-0 right-0 bottom-4 w-full max-w-xs text-white shadow-lg rounded-xl p-4 mx-auto ease-in transition-[transform_opacity] duration-200`}
    >
